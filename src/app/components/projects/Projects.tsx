...
import tunerExtentionImage from "img/tuner.png";
import CAHImage from "img/cah.png";
...
import vercelLogo from "img/vercel.png";
  ...
  return (
    <div className="text-center" style={{height: "80%"}}>
      <Carousel showStatus={false} infiniteLoop showThumbs={false}>
        <Project 
          image={CAHImage} 
          description={CAHDescription}
          name="Clone Against Humanity"
          tags={["svelte", "svelteKit", "socket.io" ]}
          links={CAHLinks}
        />
...
const CAHDescription = 
  "Clone Against Humanity is a clone of Cards Against Humanity written as an exercise to learn the svelte frame work and exercise socket.io. The client is hosted on Vercel, and the server is hosted on Render"
const CAHLinks: Link[] = [
  {
    logo: vercelLogo,
    alt: "Vercel logo",
